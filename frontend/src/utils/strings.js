export const STRINGS = {
  ...
  connectMetamask: 'Connect your Metamask wallet to Craffpp platform',
  selectBuyinMonth: 'Select the buy-in and month of the raffle you want to participate. Each buy-in represent a set of winners (First, second and third place). You will be able to seethe cumulative ETH total on every raffle per Buy-in amount. Then click Buy ticket and confirm transaction.',
  ...
  priceDistribution: ' Ocean and coastline cleanup 16%,  First place 40%, Second place 25% and Third place 15%. Remaining 4% for development team and platform maintainance.',
