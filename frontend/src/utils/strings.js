export const STRINGS = {
  ...
  transfers: 'Claim Your Prizes. After each raffle concludes on the 28th of the month, winnings are sent to your participating wallet addresses within 48 hours. Winner addresses are displayed in the platform.',
