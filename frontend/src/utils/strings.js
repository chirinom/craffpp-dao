export const STRINGS = {
  ...
  homeHeader: 'Crypto raffle for the planet & the people',
  filteredTotals: 'Filtered Totals',
  connectWallet: 'Connect Wallet',
  chooseMonthAndType: 'Choose your raffle & ticket type',
  winnerSelected: 'Win Multiple Prizes',
  recievePrice: 'Receive Your Winnings',
  connectMetamask: 'Connect your Metamask wallet.',
  selectBuyinMonth: 'Choose the specific month\'s raffle you want to participate in and your level of participation. Select from five different ticket types: Micro, Small, Mid or Large, each with varying prices.',
  raffles: 'Increase Your Chances. Buying more than one ticket increases your chances of winning. You can win both first, runner-up prizes by having multiple tickets in a single raffle.',
  transfers: 'Claim Your Prizes. After each raffle concludes on the 28th of the month, winnings are sent to your participating wallet addresses within 48 hours. Winner addresses will be displayed in the platform.',
